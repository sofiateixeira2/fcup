...
class Game {
   ...
   // Verifica se a linha que começa em (x,y) e com incrementos
   // incx e incy tem todas as posições preenchidas com o mesmo caracter
   ...
   // Devolve true se o tabuleiro estiver cheio ou false caso contrário
   boolean finished() {
      for (int i=0; i<n; i++)
         for (int j=0; j<n; j++)
