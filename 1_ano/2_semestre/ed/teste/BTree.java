...
public class BTree<T> {
   ...
   private int count(BTNode<T> n) {
     ...
     else return 1 + count(n.getLeft()) + count(n.getRight());
   }

   public int level(T v) {
     int l = 0;
     return level(root, v, l);
   }

   public int level(BTNode<T> n, T v, int l) {
     if(root == v && root.getLeft() != v && root.getRight() != v) return 0;
     if(n.getValue() != v){
       level(n.getLeft(), v, l++);
       level(n.getRight(), v, l++);
     } else return -2;
     if(n.getLeft() != null && n.getValue() == v) {
       level(n.getLeft(), v, l++);
       level(n.getRight(), v, l++);
     } else return -2;
     if(n.getRight() != null && n.getValue() == v) {
       level(n.getRight(), v, l++);
       level(n.getRight(), v, l++);
     } else return -2;
